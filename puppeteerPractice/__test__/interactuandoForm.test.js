const puppeteer = require ('puppeteer')
    ...
    describe('Prueba de Navegacion con Puppeteer', () => {
        ...
        it('Debe abrir el navegador y hacer operaciones basicas en el', async() => {
            ...
            await page.type('#developer-name', 'Ronald', { delay: 1000 })
            await page.click('#remote-testing')
            await page.click('#continuous-integration-embedding')
            await page.click('#tried-test-cafe')
            await page.click('#slider', '5')
            await page.type('#comments', 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit pariatur reiciendis nobis quos cum voluptatibus harum corrupti dolorum. Deserunt cum fugit sapiente recusandae omnis atque deleniti natus laudantium tempora ipsum!')
